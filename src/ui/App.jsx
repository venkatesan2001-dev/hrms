    ...
    <div className={`layout ${collapsed ? "sidebar-collapsed" : ""}`}>
      ...
      >
        ...
        <Menu className="sidebar-menu">
          ...
          <MenuItem
            ...
            className={location.pathname.startsWith("/sourcing") ? "active" : ""}
          >
            <div className="sibar-mono-item">
          ...
          <SubMenu
            ...
            className={location.pathname.startsWith("/onboarding") ? "active" : ""}
          >
            <MenuItem
              onClick={() => handleMenuClick("/onboarding/offer")}
              className={location.pathname === "/onboarding/offer" ? "active" : ""}
            >
            ...
            <MenuItem
              ...
              className={location.pathname === "/onboarding/joining" ? "active" : ""}
            >
            ...
            <MenuItem
              ...
              className={location.pathname === "/onboarding/probation" ? "active" : ""}
            >
              <AssignmentIcon className="menu-icon" />
          ...
          >
            <MenuItem
              ...
              className={location.pathname.startsWith("/workforce/jd-preparation") ? "active" : ""}
            >
              <AssignmentIcon className="menu-icon" />
              JD Preparation
            </MenuItem>
            <MenuItem
              ...
              className={location.pathname.startsWith("/workforce/requisition-forms") ? "active" : ""}
            >
              <AssignmentIcon className="menu-icon" />
              Requisition Forms
            </MenuItem>
      ...
      <main className="content">
        ...
        <Routes>
          ...
          <Route path="/" element={token ? <UsersIndex /> : <Navigate to="/login" replace />} />
          ...
          <Route path="/onboarding/joining" element={<JoiningFormalitiesPage />} />
